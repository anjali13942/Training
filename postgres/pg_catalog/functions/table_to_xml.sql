...
;
ALTER function table_to_xml(regclass, boolean, boolean, text) OWNER TO postgres;
GRANT execute on function table_to_xml(regclass, boolean, boolean, text) to postgres;