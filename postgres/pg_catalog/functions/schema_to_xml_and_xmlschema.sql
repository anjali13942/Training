...
;
ALTER function schema_to_xml_and_xmlschema(name, boolean, boolean, text) OWNER TO postgres;
GRANT execute on function schema_to_xml_and_xmlschema(name, boolean, boolean, text) to postgres;