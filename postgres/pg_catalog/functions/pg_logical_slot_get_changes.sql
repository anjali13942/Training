...
;
ALTER function pg_logical_slot_get_changes(name, pg_lsn, integer, text[]) OWNER TO postgres;
GRANT execute on function pg_logical_slot_get_changes(name, pg_lsn, integer, text[]) to postgres;