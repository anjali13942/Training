...
;
ALTER function make_interval(integer, integer, integer, integer, integer, integer, double precision) OWNER TO postgres;
GRANT execute on function make_interval(integer, integer, integer, integer, integer, integer, double precision) to postgres;