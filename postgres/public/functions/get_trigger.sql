...
;
ALTER function get_trigger(character varying, character varying) OWNER TO myuser;
GRANT execute on function get_trigger(character varying, character varying) to myuser;